...
def getImage(filename):
    ...
    image = tf.reshape(1 - image, [height * width * channel], name= 'reshape')
...
y_ = tf.placeholder(tf.float32, [None, numClass], name='y_')
...
if simpleModel:
    ...
    weight = tf.Variable(tf.zeros([width* height * channel, numClass]))
